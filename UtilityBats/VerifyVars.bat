...
if not exist "%SteamInstall%\War.exe" set err=1
...
:errHandling
if not exist "%SteamInstall%\War.exe" echo SteamInstall of "%SteamInstall%" is invalid, please check GlobalConfig.ini and LocalConfig.ini. Note that SteamInstall should be the folder containing War.exe
